...
--
-- Host: localhost    Database: pet_finder
-- ------------------------------------------------------
...
CREATE TABLE `factura_servicio` (
  ...
  KEY `fkfactura_servicio_factura` (`servicio_id_servicio`),
  CONSTRAINT `fkfactura_factura_servicio` FOREIGN KEY (`factura_id_factura`) REFERENCES `factura` (`id_factura`),
  CONSTRAINT `fkfactura_servicio_factura` FOREIGN KEY (`servicio_id_servicio`) REFERENCES `servicios` (`id_servicio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `facturas` (
  ...
  PRIMARY KEY (`id_factura`),
  KEY `fkclientes_info` (`clientes_id_clientes`),
  CONSTRAINT `fkclientes_info` FOREIGN KEY (`clientes_id_clientes`) REFERENCES `clientes` (`id_cliente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `servicios` (
  ...
  `tipo_membresia` varchar(40) DEFAULT NULL,
  `numero_chip_mascota` int DEFAULT NULL,
...
-- Dump completed on 2024-02-22 20:19:16
